...
# recipient_id → jisko notification bhejna hai (post owner)

# actor_id → kisne action kiya (liker/commenter)

# notification_type → "like", "comment", "follow"

# post_id (optional) → kis post par action hua

# comment_id (optional) → kis comment par action hua
...
# message (optional) → custom message
    ...
    notification = Notification(
        # Inputs ko model me map kar rahe ho
